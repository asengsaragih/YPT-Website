...
if (empty($_SESSION['email'])) {
        ...
        <form class="login-form" method="POST" action="checkLogin.php">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix" id="email" type="email" autocomplete="off" placeholder="Email" name="email" autofocus="" required /> </div>
            </div>
            <div class="form-group">
                <label class="control-label visible-ie8 visible-ie9">Password</label>
                <div class="input-icon">
                    <i class="fa fa-lock"></i>
                    <input class="form-control placeholder-no-fix" id="password" type="password" autocomplete="off" placeholder="Password" name="password" required/> </div>
            </div>
            <div class="form-group">
                <input type="submit" class="btn red btn-block" value="Login" name="login"/>
            </div>
    ...
    <!-- END LOGIN -->
    <!-- BEGIN COPYRIGHT -->
    <div class="copyright"> 2020 &copy; Yayasan Pendidikan Telkom. </div>
    <!-- END COPYRIGHT -->
